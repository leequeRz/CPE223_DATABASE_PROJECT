    ...
    <body>
        ...
        <section id="prodetails" class="section-p1">
            <div class="single-pro-image">
                <img src="/database_project/img/products/แกงส้มกุ้ง.jpeg" width="100%" height="500px" id="MainImg" alt="">
            ...
            <div class="single-pro-details">
                ...
                <span>กุ้งตัวใหญ่ๆ แกงส้มรสชาติเข้มข้น ต้องลองงงงงงงงงงงง</span>
            </div>
        </section>
        ...
        <section id="product1" class="section-p1">
            ...
            <div class="pro-container">
                <div class="pro">
                    <img src="/database_project/img/products/เป็ดปักกิ่งง.jpg" alt="" onclick="window.location.href='sproduct10.php';">
                    <div class="des">
